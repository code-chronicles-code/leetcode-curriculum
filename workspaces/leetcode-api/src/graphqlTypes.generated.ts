...
export type FavoriteQuestionFilterInput = {
  ...
  questionStatusList: InputMaybe<Array<InputMaybe<FavoriteQuestionStatusEnum>>>;
...
export type ManagementTagsInput = {
  excludeTagCategoryIds: InputMaybe<Array<InputMaybe<Scalars["Int"]["input"]>>>;
...
export type Query = {
  ...
  privateContestRegisteredUserIds: Maybe<Array<Maybe<Scalars["ID"]["output"]>>>;
